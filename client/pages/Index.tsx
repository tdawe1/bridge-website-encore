...
export default function Index() {
  const handleBookDiscovery = () => {
    ...
    window.open("https://calendly.com/bridge-signal/discovery-sprint", "_blank");
  };
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl text-body max-w-3xl mx-auto mb-12 leading-relaxed">
            At Bridge & Signal, we create custom tools tailored to the way your business{" "}
            <em className="italic">actually</em> works—automating repetitive tasks so your team can focus on growth.
          </p>
          <button 
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-headline mb-4">
                Discover
                <span className="block text-lg font-medium text-brand-electric-blue mt-1">(1-2 Weeks)</span>
              </h3>
              <p className="text-body text-lg leading-relaxed">
                We partner with you to map your workflows and identify the 3-5 bottlenecks with the highest potential for ROI.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-headline mb-4">
                Build
                <span className="block text-lg font-medium text-brand-electric-blue mt-1">(2-4 Weeks)</span>
              </h3>
              <p className="text-body text-lg leading-relaxed">
                We build a lightweight, working tool that solves your most critical problem first and train your team on how to use it.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-body text-lg leading-relaxed">
                We roll out a production-ready solution that delivers measurable time savings and a clear return on investment.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-12 text-left">
            ...
            <div className="bg-brand-white border-l-4 border-brand-electric-blue pl-8 py-6">
              <p className="text-lg text-body leading-relaxed">
                <strong className="text-headline">Spending hours refreshing job boards just to secure work?</strong>{" "}
                Our translation workflow now captures jobs automatically, filters for quality, and delivers first-pass translations—letting our client reliably generate revenue{" "}
                <strong className="text-headline">without</strong> constant monitoring.
              </p>
            </div>
            ...
            <div className="bg-brand-white border-l-4 border-brand-electric-blue pl-8 py-6">
              <p className="text-lg text-body leading-relaxed">
                <strong className="text-headline">Buried in spreadsheets every week?</strong>{" "}
                Our automated reporting dashboard now{" "}
                <strong className="text-brand-electric-blue">frees up 10+ hours of expert time</strong>, letting the team focus on generating leads and strategy instead of wrangling data. It's the power of Tableau, without the bloat.
              </p>
            </div>
            ...
            <div className="bg-brand-white border-l-4 border-brand-electric-blue pl-8 py-6">
              <p className="text-lg text-body leading-relaxed">
                <strong className="text-headline">Struggling to produce accurate quotes quickly?</strong>{" "}
                Our lightweight quoting tool now generates complex quotes in minutes,{" "}
                <strong className="text-brand-electric-blue">cutting reconciliation time by 70%</strong>{" "}
                and nearly eliminating costly errors—so the team can focus on winning business.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-brand-charcoal">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
            The first step is a no-obligation Discovery Call. We'll map your workflows, understand your business, and identify the opportunities that will have a real impact on your bottom line.
          </p>
          <button 
            onClick={handleBookDiscovery}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h3 className="text-2xl font-bold text-headline">Bridge & Signal</h3>
