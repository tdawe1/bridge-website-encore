  ...
  return (
    <div className="min-h-screen bg-brand-white">
      <div className="max-w-4xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl font-bold text-headline mb-8">
          Privacy Policy
        </h1>

        <div className="prose prose-lg max-w-none text-body">
          <p className="text-xl mb-8">
            This is a placeholder privacy policy page. Bridge & Signal takes
            your privacy seriously and will implement a comprehensive privacy
            policy here.
          </p>
          ...
          <div className="bg-brand-soft-gray p-8 rounded-lg">
            ...
            <p>
              ...
              here shortly. If you have any questions about how we handle your
